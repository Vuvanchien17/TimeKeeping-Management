  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e1e1e1; border-radius: 10px; overflow: hidden;">
      <div style="background-color: #007bff; color: white; padding: 20px; text-align: center;">
        <h1 style="margin: 0; font-size: 24px;">JUST.engineer</h1>
      </div>
      <div style="padding: 30px; line-height: 1.6; color: #333;">
        <h2 style="color: #007bff;">Xác thực quên mật khẩu</h2>
        <p>Chào bạn,</p>
        <p>Chúng tôi nhận được yêu cầu khôi phục mật khẩu cho tài khoản Timekeeping-Management của bạn. Vui lòng sử dụng mã OTP dưới đây để tiếp tục:</p>
